...
#    PROJECT
#    Code Designed and Written By:
#    Name      : Fay-Yaadhah Aqeelah Paraouty______________
#    AndrewID  : fparaout______________

#    File Created:20/09/2016
#    Modification History:
#    Start                        End
#    07/11/2016 12:30 pm          6:00 pm
#    08/11/2016 9:00 am           3:00 am
#    09/11/2016 11:00 am          1:00 am
#    10/11/2016 8:00 am           9:00 pm
#    11/11/2016 9:00 am           10:00 pm
#    12/11/2016 9:00 am           7:00 pm
#    13/11/2016 7:00 am           1:00pm
#    14/11/2016 3:00 pm           12:00am
#    15/11/2016 9:00 am           12:oopm
#    16/11/2016 9:00 am          10:00pm
#    17/11/2016 6:oopm           2:00am
#    18/11/2016 8:ooam           6:00pm
#    19/11/2016 4:oo pm          3:00am
#    20/11/2016 11:ooam          11:00pm
#    21/11/2016 9:00 am          9:00pm
#    22/11/2016 6:00pm           2:00am
#    23/11/2016 4:oopm           3:00am
#    24/11/2016 9:00 am          11:oopm 
#    25/11/2016 7:oo am          4:oo am
...
##referred from a website related to ttk library online
...
def butn7A(txt7):
    ...
    try:
        ...
        fontYes = tkFont.Font(family='Helvetica',size=13, weight='bold')
        labelDone7=Label(wndDone7,text="Done!!! Your speech has been processed!",foreground='purple',background='pink',font=fontYes)
        labelDone7.pack()
        labelDone7.place(x=15,y=3)
        ...
        dialog_label=Label(wndSave1,image=dialogImage)
        dialog_label.image=dialogImage
        dialog_label.pack()
        dialog_label.place(x=20,y=3)### 
        #print("Google Speech Recognition could not understand audio")
    except sr.RequestError as e:
        print("Could not request results from Google Speech Recognition service; {0}".format(e))
...
def butnS1Yes(wnd,txt1,wndSave1):
    ...
    fontYes = tkFont.Font(family='Helvetica',size=13, weight='bold')
    btnSaved1.configure(width=6,height=1,font=fontYes, relief=RAISED)
    btnSaved1.pack()
...
def butnU1Yes(wnd,wndU1, bullet_label,txt1):
    ...
    fontYes = tkFont.Font(family='Helvetica',size=13, weight='bold')
    btnU1U.configure(width=6,height=1,font=fontYes, relief=RAISED)
    btnU1U.pack()
